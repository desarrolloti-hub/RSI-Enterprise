...
// Verificar asistencia en Firebase
...
// Verificar asistencia en colaboradores
...
function getLocation() { 
    return new Promise((resolve, reject) => {
        ...
        if (!navigator.geolocation) {
            reject(rechazarComoUsuario("Geolocalización no soportada por el navegador")); 
            return;
        }
        ...
        navigator.geolocation.getCurrentPosition(
            (position) => {
                ...
                if (position.coords.accuracy > 1000) {
                    reject(rechazarComoUsuario("La precisión de la ubicación es demasiado baja. Intenta en un área con mejor señal.")); 
                    return;
                }
                const coordinates = { 
