    ...
    generateActionButtons: function(data, ticketId, userUid, isColaborator, isAccepted, userEvidence, ticketEstaFinalizado) {
        ...
        if (isColaborator && !ticketEstaFinalizado) {
            ...
            if (isAccepted) {
                if (!userEvidence) {
                    buttons += `
                        <a href="/vista/nav-mesa-operadores/finalizar-ticket/finalizar-ticket.html?ticketId=${ticketId}" class="action-btn-ticket btn-success">
                            <i class="fas fa-check-circle"></i> Finalizar Ticket
                        </a>
                    `;
                } else {
                    buttons += `
                        <a href="/vista/nav-mesa-operadores/finalizar-ticket/finalizar-ticket.html?ticketId=${ticketId}&edit=true" class="action-btn-ticket btn-info">
