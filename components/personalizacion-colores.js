...
// Ahora importa la configuración de firebase-config.js
...
(async function() {
    ...
    try {
        ...
        console.log('✅ Firebase config importado correctamente');
        ...
        async function init() {
            console.log('🎨 Cargando preferencias de personalización...');
        ...
        console.error('❌ Error al inicializar personalización de colores:', error);
        ...
        // Función de respaldo para aplicar estilos básicos
        function applyFallbackStyles() {
            const styleId = 'personalizacion-colores-fallback';
            let styleElement = document.getElementById(styleId);
